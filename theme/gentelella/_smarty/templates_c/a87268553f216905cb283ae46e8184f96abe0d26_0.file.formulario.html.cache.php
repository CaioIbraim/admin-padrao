...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_589214d04eb706_76665011',
...
function content_589214d04eb706_76665011 (Smarty_Internal_Template $_smarty_tpl) {
$_smarty_tpl->compiled->nocache_hash = '3512589214cfba2106_73143639';
?>
...
$__section_x_0_loop = (is_array(@$_loop=$_smarty_tpl->tpl_vars['arrCombo']->value) ? count($_loop) : max(0, (int) $_loop));
...
?>
    			<option value="<?php echo $_smarty_tpl->tpl_vars['arrCombo']->value[(isset($_smarty_tpl->tpl_vars['__smarty_section_x']->value['index']) ? $_smarty_tpl->tpl_vars['__smarty_section_x']->value['index'] : null)]['c_categ_ctro_atvdd'];?>
" <?php if ($_smarty_tpl->tpl_vars['arrCombo']->value[(isset($_smarty_tpl->tpl_vars['__smarty_section_x']->value['index']) ? $_smarty_tpl->tpl_vars['__smarty_section_x']->value['index'] : null)]['c_categ_ctro_atvdd'] == $_smarty_tpl->tpl_vars['arrDados']->value['c_categ_ctro_atvdd']) {?>selected<?php }?>><?php echo $_smarty_tpl->tpl_vars['arrCombo']->value[(isset($_smarty_tpl->tpl_vars['__smarty_section_x']->value['index']) ? $_smarty_tpl->tpl_vars['__smarty_section_x']->value['index'] : null)]['r_categ_ctro_atvdd'];?>
</option>
    		<?php
}
}
...
?>
	...
	<div class="form-group">
    	...
    	<div class="col-xs-12 col-sm-10 col-md-10 col-lg-10 obrigatorio">
      		<input type="text" id="r_ctro_atvdd" name="r_ctro_atvdd" value="<?php echo $_smarty_tpl->tpl_vars['arrDados']->value['r_ctro_atvdd'];?>
" <?php echo $_smarty_tpl->tpl_vars['TelaReadOnly']->value;?>
 placeholder="Nome do Centro de Atividades " maxlength="100" class="form-control" required>
    	</div>
  	</div>
	...
	<div class="form-group">
  	...
  	<div class="form-group" id="btnBoxFooter">
    	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-right">  
    		<input type="hidden" id="c_ctro_atvdd" name="c_ctro_atvdd" value="<?php echo $_smarty_tpl->tpl_vars['arrDados']->value['c_ctro_atvdd'];?>
">
