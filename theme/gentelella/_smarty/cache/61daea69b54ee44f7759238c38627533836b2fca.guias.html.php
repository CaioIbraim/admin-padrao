...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_59aff53cb5c0e8_07347909',
...
function content_59aff53cb5c0e8_07347909 (Smarty_Internal_Template $_smarty_tpl) {
?>
<div class="page-title">
		...
		<ol class="breadcrumb">
		  <li><a href="http://10.4.225.62/produtividade/"><i class="fa fa-home"></i> Principal</a></li>
		  		  ...
		  		  <li class="active">Guias Autorizadas/Não autorizadas</li>
		  		</ol>
...
<div class="x_panel">
	<div class="x_title">
		<h2>Guias autorizadas e não autorizadas, por mês/usuário</h2>
		<div class="clearfix"></div>
	</div>
	<div class="x_content">
<div class="row">
...
<option value="09" selected="selected" class="form-control option" id="mes-8">Setembro</option>
<option value="10" class="form-control option" id="mes-9">Outubro</option>
...
<option value="2013" class="form-control option" id="ano-4">2013</option>
</select>
