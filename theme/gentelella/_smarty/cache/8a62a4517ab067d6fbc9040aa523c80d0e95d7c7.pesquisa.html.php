...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_598a0d1d919282_59221307',
...
function content_598a0d1d919282_59221307 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!-- script e css da tela -->
<script src="http://10.4.224.74/sigsaude/views/_jquery/jquery.mask.min.js"></script>
...
$(document).ready(function(){
	...
	$('#pesquisa_om').change(function(){
        $('#pesquisa_ose').load('http://10.4.224.74/sigsaude/guia-pesquisa/carregacombo/'+$('#pesquisa_om').val() );
        //$('#divPesquisa').html('');
        if ($("#pesquisa_ose").val() != "") {
	...
	imprimirGuia = function(numero){
		...
		$('#frmFormularioAux').attr('action','http://10.4.224.74/sigsaude/guia-imprimir/pdf');
	...
	pesquisarAjax = function(){
		$.ajax({
            url: "http://10.4.224.74/sigsaude/guia-pesquisa/retornopesquisa",
