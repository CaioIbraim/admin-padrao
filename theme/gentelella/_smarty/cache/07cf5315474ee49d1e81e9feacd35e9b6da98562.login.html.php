<?php
/* Smarty version 3.1.30, created on 2017-08-21 08:31:39
  from "C:\xampp\htdocs\estatistica_regulacao\views\login\login.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_599ac49b9b8407_06687153',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '78a449e928f2d4db6922044998a74598a59e32cb' => 
    array (
      0 => 'C:\\xampp\\htdocs\\estatistica_regulacao\\views\\login\\login.html',
      1 => 1492453217,
      2 => 'file',
    ),
  ),
...
function content_599ac49b9b8407_06687153 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!DOCTYPE html>
	<html lang="pt-br">
		<head>
		<meta charset = "utf-8" />
		<title>ESTATISTICA REGULAÇÃO - 1.0</title>
		<link href="html/images/favicon.png" rel="shortcut icon" />

		<meta name="description" content="Formulários - Saúde Naval" />
		<meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0" />

    	<link rel="stylesheet" href="http://localhost/estatistica_regulacao/views/_bootstrap/css/bootstrap.min.css">
		<link rel="stylesheet" href="http://localhost/estatistica_regulacao/views/_css/login.css" type="text/css" />
		<link rel="stylesheet" href="http://localhost/estatistica_regulacao/views/_font-awesome/css/font-awesome.min.css" type="text/css" />
	...
	<body class='home'>
		...
		<div class="container vertical-center">
			...
			<div class='col-md-offset-2 col-md-8 cor_fundo padding'>
				<div class='col-md-5 login'>
               		...
               		<form method="" action="http://localhost/estatistica_regulacao/login/entrar" onsubmit="return true;" id="frmLogin">
						<h1>ESTATISTICA REGULAÇÃO - 1.0</h1>
		...
		<footer>
			<div class='col-md-12 col-lg-12 col-sm-12 col-xs-12 rodape'>
				<img src='http://localhost/estatistica_regulacao/views/_images/marinha.png' alt='Marinha'>
				<div class='texto_rodape'>110 Anos Cuidando da Saúde da Família Naval</div>
			</div>
		</footer>
		
	    <!-- IE10 viewport hack for Surface/desktop Windows 8 bug -->
	    <script src="http://localhost/estatistica_regulacao/views/_bootstrap/assets/js/ie10-viewport-bug-workaround.js"></script>
	    
	    <!-- script e css da tela -->
		<script src="http://localhost/estatistica_regulacao/views/_jquery/jquery.min.js"></script>
		<script src="http://localhost/estatistica_regulacao/views/_jquery/jquery.mask.min.js"></script>
		<script src="http://localhost/estatistica_regulacao/views/_jquery/jquery.validate/jquery.validate.min.js"></script>
		<script src="http://localhost/estatistica_regulacao/views/_jquery/jquery.validate/localization/messages_pt_BR.js"></script>
		<script src="http://localhost/estatistica_regulacao/views/_bootstrap/js/bootstrap.min.js"></script>
