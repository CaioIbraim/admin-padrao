...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_59c1677382e412_25788390',
...
function content_59c1677382e412_25788390 (Smarty_Internal_Template $_smarty_tpl) {
?>
...
<option value="59" id="om-4">CFAT</option>
<option value="326" id="om-5">CFPA</option>
<option value="320" id="om-6">CFRP</option>
<option value="72" id="om-7">CFS</option>
<option value="65" id="om-8">CFSF</option>
<option value="99" id="om-9">CFTP</option>
<option value="195" id="om-10">CMAM</option>
<option value="85" id="om-11">CN</option>
<option value="571" id="om-12">CNBE</option>
<option value="572" id="om-13">CNBW</option>
<option value="319" id="om-14">COM5ºDN</option>
<option value="156" id="om-15">COM8ºDN</option>
<option value="371" id="om-16">COM9ºDN</option>
<option value="293" id="om-17">CPAL</option>
<option value="335" id="om-18">CPAP</option>
<option value="300" id="om-19">CPMA</option>
<option value="42" id="om-20">CPMM</option>
<option value="292" id="om-21">CPPB</option>
<option value="301" id="om-22">CPPI</option>
<option value="323" id="om-23">CPPR</option>
<option value="272" id="om-24">CPSE</option>
<option value="108" id="om-25">CPSP</option>
<option value="568" id="om-26">CTMSP</option>
<option value="328" id="om-27">DELGUAIRA</option>
<option value="273" id="om-28">DELILHEUS</option>
<option value="165" id="om-29">DELITAJAI</option>
<option value="64" id="om-30">DELLAGUNA</option>
<option value="104" id="om-31">DELPEPITACIO</option>
<option value="62" id="om-32">DELPSEGURO</option>
<option value="325" id="om-33">DELSFSUL</option>
<option value="121" id="om-34">DELSSEBASTIAO</option>
<option value="60" id="om-35">DELURUGUAIANA</option>
<option value="237" id="om-36">DSM</option>
<option value="286" id="om-37">EAMCE</option>
<option value="94" id="om-38">EAMES</option>
<option value="321" id="om-39">EAMSC</option>
<option value="80" id="om-40">HCM</option>
<option value="308" id="om-41">HNBE</option>
<option value="260" id="om-42">HNBRA</option>
<option value="250" id="om-43">HNLA</option>
<option value="70" id="om-44">HNMD</option>
<option value="295" id="om-45">HNNA</option>
<option value="299" selected="selected" id="om-46">HNRE</option>
<option value="274" id="om-47">HNSA</option>
<option value="82" id="om-48">OCM</option>
<option value="570" id="om-49">PNCG</option>
<option value="332" id="om-50">PNMA</option>
<option value="411" id="om-51">PNN</option>
<option value="86" id="om-52">PNNSG</option>
<option value="663" id="om-53">PNRG</option>
<option value="205" id="om-54">PNSPA</option>
<option value="84" id="om-55">SNNF</option>
<option value="353" id="om-56">UISM</option>
</select>
				...
				<div class="col-md-3">
					<select name="foo" id="cbos" data-actions-box="true" multiple="multiple">
