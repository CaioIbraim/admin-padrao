...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_59aec79bcdc460_07450390',
...
function content_59aec79bcdc460_07450390 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!DOCTYPE html>
	<html lang="pt-br">
		<head>
		<meta charset = "utf-8" />
		<title>PRODUTIVIDADE REGULAÇÃO - 1.0</title>
		<link href="html/images/favicon.png" rel="shortcut icon" />

		<meta name="description" content="Formulários - Saúde Naval" />
		<meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0" />

    	<link rel="stylesheet" href="http://10.4.225.62/produtividade/views/_bootstrap/css/bootstrap.min.css">
		<link rel="stylesheet" href="http://10.4.225.62/produtividade/views/_css/login.css" type="text/css" />
		<link rel="stylesheet" href="http://10.4.225.62/produtividade/views/_font-awesome/css/font-awesome.min.css" type="text/css" />
	...
	<body class='home'>
		...
		<div class="container vertical-center">
			...
			<div class='col-md-offset-2 col-md-8 cor_fundo padding'>
				<div class='col-md-5 login'>
               		...
               		<form method="" action="http://10.4.225.62/produtividade/login/entrar" onsubmit="return true;" id="frmLogin">
						<h1>PRODUTIVIDADE REGULAÇÃO - 1.0</h1>
		...
		<footer>
			<div class='col-md-12 col-lg-12 col-sm-12 col-xs-12 rodape'>
				<img src='http://10.4.225.62/produtividade/views/_images/marinha.png' alt='Marinha'>
				<div class='texto_rodape'>110 Anos Cuidando da Saúde da Família Naval</div>
			</div>
		</footer>
		
	    <!-- IE10 viewport hack for Surface/desktop Windows 8 bug -->
	    <script src="http://10.4.225.62/produtividade/views/_bootstrap/assets/js/ie10-viewport-bug-workaround.js"></script>
	    
	    <!-- script e css da tela -->
		<script src="http://10.4.225.62/produtividade/views/_jquery/jquery.min.js"></script>
		<script src="http://10.4.225.62/produtividade/views/_jquery/jquery.mask.min.js"></script>
		<script src="http://10.4.225.62/produtividade/views/_jquery/jquery.validate/jquery.validate.min.js"></script>
		<script src="http://10.4.225.62/produtividade/views/_jquery/jquery.validate/localization/messages_pt_BR.js"></script>
		<script src="http://10.4.225.62/produtividade/views/_bootstrap/js/bootstrap.min.js"></script>
