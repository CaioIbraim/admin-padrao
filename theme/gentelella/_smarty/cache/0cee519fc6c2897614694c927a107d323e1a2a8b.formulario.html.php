<?php
/* Smarty version 3.1.30, created on 2017-01-26 11:27:16
  from "D:\www\catalogo\views\pessoas\formulario.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5889f9343369a8_63393633',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '1a6e4a7fbeb9604309d35401b0d3a330919a539a' => 
    array (
      0 => 'D:\\www\\catalogo\\views\\pessoas\\formulario.html',
      1 => 1485437231,
      2 => 'file',
    ),
  ),
...
function content_5889f9343369a8_63393633 (Smarty_Internal_Template $_smarty_tpl) {
?>
...
<div id="msgAjax"></div>
<div class="page-header sigsaude"><h2>Pessoas <small><i class="fa fa-angle-double-right"></i> Alterar dados</small></h2></div>
	...
	<div class="tab-content">
		...
		<div role="tabpanel" class="tab-pane active" id="DadosPessoais">
			<div class="form-group">
		    	...
		    	<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 obrigatorio">
		      		<input type="text" id="i_pssoa" name="i_pssoa" value="aaaaaaaaasdfasdfsdf"  placeholder="Nome" maxlength="80" class="form-control" required>
		    	</div>
			...
			<div class="form-group">
		    	...
		    	<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
		    		...
		    		<option value="2" selected>Extrangeiro</option>
		    		</select>
		    	</div>
		...
		<div role="tabpanel" class="tab-pane" id="Contatos">
			...
			<div class="form-group">
		    	...
		    	<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
		      		<input type="text" id="i_email_infmd" name="i_email_infmd" value="asdfasd@asdfas.com"  placeholder="E-mail" maxlength="100" class="form-control">
		    	</div>
		  	</div>
  	...
  	<div class="form-group" id="btnBoxFooter">
    	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-right">  
    		<input type="hidden" id="c_pssoa" name="c_pssoa" value="383701">
    		...
    		<button type="button" id="btnCancelar" class="btn btn-default" onclick="window.location.href='pessoas';">Retornar</button>
	...
	// Validação do formulário
   	$("#frmFormulario").validate({
		...
		submitHandler: function (form) {
			$.ajax({
	            url: "http://localhost/catalogo/pessoas/confirmaralterar",
   	...
   	$("#btnCEP").click(function() {
	    ...
	    $("#texto_estado").val('');
 		...
 		$("#c_pais").val('');
   		...
   		$.ajax({
   		    url: "http://localhost/catalogo/pessoas/buscacep",
	   		dataType: "json",
   		    type: "post",
